...
#############################################################################
**************************************************************************/
/* $Id: CMDhandler_link.c,v 1.6 2001/02/16 05:44:25 lafisk Exp $ */
...
VOID 
CMDhandler_link( control_msg_handle *mh)
{
hostReply_t ack;
...
int gid_real = getgid();
    ...
    if (DBG_FLAGS(DBG_IO_1)) {
        fprintf(stderr,"CMDhandler_link() nid %i pid %i\n", snid, spid);
    }
