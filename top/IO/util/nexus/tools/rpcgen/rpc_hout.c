...
static void storexdrfuncdecl();

static void pconstdef();
static void pstructdef();
static void puniondef();
static void pdefine();
static void pprogramdef();
static void parglist();
static void penumdef();
static void ptypedef();
static int undefined2();
static void pprocdef();
