...
**************************************************************************/
/*
** $Id: srvr_err.h,v 1.6 2001/02/05 02:30:46 lafisk Exp $
*/
#ifndef SRVR_ERRH
#define SRVR_ERRH
...
/*
** returns pointer to error string for p30 errors
*/
extern int srvr_p30errno;
char *p30strerror(int errnum);

#define CLEAR_ERR  (errno = srvr_p30errno = CPerrno = 0)
