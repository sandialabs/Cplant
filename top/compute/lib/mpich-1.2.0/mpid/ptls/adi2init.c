/*
 *  $Id: adi2init.c,v 1.1 2000/02/18 03:22:46 rbbrigh Exp $
 *
...
char ***argv;
{
	...
	*error_code = MPI_ERR_INTERN;
    ...
    MPIR_shandles   = MPID_SBinit( sizeof( MPIR_PSHANDLE ), ptls_match_list_size, 100 );
    MPIR_rhandles   = MPID_SBinit( sizeof( MPIR_PRHANDLE ), ptls_match_list_size, 100 );
