...
struct _MPIR_SHANDLE {
    ...
    struct MPIR_COMMUNICATOR *comm;/* Do we need this? Yes! */
    ...
    MATCH_DESC_TYPE *read_match_desc;/* for long protocol              */
    MATCH_DESC_TYPE *ack_match_desc; /* for synchronous short protocol */
...
struct _MPIR_RHANDLE {
    ...
    /* Portals specific */
    MATCH_DESC_TYPE *recv_match_desc;
    SEND_INFO_TYPE   send_info;     /* for sending acks and pull requests */
...
/* Cancelled messages are not supported. */
