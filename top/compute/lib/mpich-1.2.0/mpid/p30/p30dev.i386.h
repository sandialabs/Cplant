...
#include "p30priv.h"
#include "p30_default_long_msg.i386.h"
...
#else
#define P30_PROTOCOL_MASK 0xf0000000
#define P30_CONTEXT_MASK  0x0ff00000
#define P30_SOURCE_MASK   0x000ff000
#define P30_TAG_MASK      0x00000fff
#endif
...
#else
#define P30_SHORT_MSG     0x10000000
#define P30_LONG_MSG      0x20000000
#define P30_READY_MSG     0x40000000
#endif
