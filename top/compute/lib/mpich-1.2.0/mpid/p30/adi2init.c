/*
 *  $Id: adi2init.c,v 1.1 2000/02/18 03:22:10 rbbrigh Exp $
 *
...
char ***argv;
{
	...
	*error_code = MPI_ERR_INTERN;
    ...
    MPIR_shandles   = MPID_SBinit( sizeof( MPIR_PSHANDLE ), _mpi_p30_default_me_size, 100 );
    MPIR_rhandles   = MPID_SBinit( sizeof( MPIR_PRHANDLE ), _mpi_p30_default_me_size, 100 );
