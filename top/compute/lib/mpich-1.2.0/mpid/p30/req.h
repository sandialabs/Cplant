...
struct _MPIR_SHANDLE {
    ...
    ptl_handle_me_t   me_handle; /* for long and sync sends */
    int               got_sent, got_ack, ack_mlength; /* for long and sync sends */
    eq_handle_list_t *eq_handle_list_ptr;
