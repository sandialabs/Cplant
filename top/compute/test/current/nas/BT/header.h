...
c---------------------------------------------------------------------
     ...
     >   lhs     (5,5,3,-1:IMAX-1,  -1:JMAX-1,  -1:KMAX-1, maxcells),
     >   backsub_info (0:MAX_CELL_DIM, 0:MAX_CELL_DIM, 5,  maxcells),
     ...
     >             start_recv_north, start_recv_bottom, start_recv_top
      ...
      double precision fjac(5, 5, -2:IMAX+1, -2:JMAX+1, -2:KMAX+1),
     >                 njac(5, 5, -2:IMAX+1, -2:JMAX+1, -2:KMAX+1),
     >                 tmp1, tmp2, tmp3
