...
static int  nfs_file_ioctl(struct inode *inode, struct file * file, int cmd, unsigned long arg);

struct file_operations nfs_file_operations = {
	llseek:		default_llseek,
	read:		nfs_file_read,
	write:		nfs_file_write,
	ioctl:		nfs_file_ioctl,
	mmap:		nfs_file_mmap,
	open:		nfs_open,
...
static int
nfs_file_ioctl(struct inode *inode, struct file * file, int cmd, unsigned long arg)
{
